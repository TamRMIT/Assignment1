...
int main(int argc, char* argv[])
{
	while (true)
	{
		...
		else
		{
			...
			{
				number1 = convertstringtoint(removedecimalpoint(arg[0]));
			...
			{
				opnumber = convertoperator(arg[1]);
				check++;
			}
			...
			{
				number2 = convertstringtoint(removedecimalpoint(arg[2]));
